...
INSERT INTO "new_Car" ("brand", "color", "createdAt", "description", "id", "mileage", "model", "price", "status", "title", "updatedAt", "year") SELECT "brand", "color", "createdAt", "description", "id", "mileage", "model", "price", "status", "title", "updatedAt", "year" FROM "Car";
DROP TABLE "Car";
